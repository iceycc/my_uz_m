...
define('COREFRAME_ROOT','E:/svn/coreframe/');//定义核心框架的路径
define('CACHE_ROOT','E:/svn/caches/');//缓存文件目录
define('CACHE_EXT','dziff');
...
define('WEBURL','http://m.uzhuang.com/');//网站域名

//Cookie配置
define('COOKIE_DOMAIN','');//Cookie 作用域
define('COOKIE_PATH','');//Cookie 作用路径
define('COOKIE_PRE','NDb_'); //Cookie 前缀
define('COOKIE_TTL',0); //Cookie 生命周期，0 表示随浏览器进程

//附件相关配置
define('ATTACHMENT_ROOT',WWW_ROOT.'uploadfile/');
define('ATTACHMENT_URL','http://m.uzhuang.com/uploadfile/');//附件路径
define('PHOTOS_ROOT',WWW_ROOT.'photosBox/');
define('PHOTOS_URL','http://m.uzhuang.com/photosBox/');//附件路径
define('R','http://m.uzhuang.com/res/');//静态文件存储目录
define('_KEY','yuZw27Hy'); //密钥,最长8位
