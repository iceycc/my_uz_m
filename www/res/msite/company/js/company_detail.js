...
function getSource(){
	...
	if(browser.versions.weixin){
		$("#apply-btn").attr("href", "mobile-ordered.html?id=微信-口碑公司详情页-"+company_name+"&page_id="+company_id+"&type=works");
	}else if(browser.versions.weibo){
		$("#apply-btn").attr("href", "mobile-ordered.html?id=微博-口碑公司详情页-"+company_name+"&page_id="+company_id+"&type=works");
	}else{
		$("#apply-btn").attr("href", "mobile-ordered.html?id=M站-口碑公司详情页-"+company_name+"&page_id="+company_id+"&type=works");
	}
}