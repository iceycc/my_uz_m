$(function(){
	...
	function getSource(){
		...
		if(browser.versions.weixin){
			$("#order").attr("href", "mobile-ordered.html?id=微信-设计师详情页-"+company_name+"-"+designer_name+"&page_id="+designer_id+"&type=designer");
		}else if(browser.versions.weibo){
			$("#order").attr("href", "mobile-ordered.html?id=微博-设计师详情页-"+company_name+"-"+designer_name+"&page_id="+designer_id+"&type=designer");
		}else{
			$("#order").attr("href", "mobile-ordered.html?id=M站-设计师详情页-"+company_name+"-"+designer_name+"&page_id="+designer_id+"&type=designer");
		}
	}
});
