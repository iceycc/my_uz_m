...
//PersonInfo
function PersonInfo(i){
	
	$.ajax({
		type: "POST",
		
		//http://m.uzhuang.com/index.php?m=zx_recommended&f=member&v=personal_center
		url: "index.php?m=zx_recommended&f=member&v=personal_center&uid="+i,
		dataType: "json",
		timeout: 3000,
...
function fixInfoFn(tempName,tempSex){
	...
	$.ajax({
		...
		type: "POST",
		//http://m.uzhuang.com/index.php?m=zx_recommended&f=member&v=personal_center
		url: "index.php?m=zx_recommended&f=member&v=edit",
		data:{
			"nickname":tempName,
			"sex":tempSex,
			"uid":tempUid
...
$("#code").live("tap",function(event){
		...
		$.ajax({
			...
			//http://m.uzhuang.com/index.php?m=zx_recommended&f=member&v=personal_center
			url: "index.php?m=zx_recommended&f=member&v=personal_center&uid="+tempUid,
			dataType: "json",
			timeout: 3000,
			success: function(data){
...
function delCookie(){  
    $.ajax({
		  ...
		  url: "index.php?m=zx_recommended&f=password&v=logout",
		  dataType: "json",
		  timeout: 3000,
		  success: function(data){
