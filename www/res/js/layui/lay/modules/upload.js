 ...
 layui.define("layer", function(e) {
 	...
 	s.prototype.init = function() {
 		...
 		return a("#" + n)[0] || r.append(u), s.each(function(r, s) {
 			s = a(s);
 			var u = '<form target="' + n + '" method="' + (t.method || "post") + '" key="set-mine" enctype="multipart/form-data" action="' + (t.url || "") + '"><input type=""></form>',
 			...
 			$(".layedit-tool-image .token-input").remove();
 			$(".layedit-tool-image form").append("<input type='hidden' >")
 		})
