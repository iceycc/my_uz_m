                      ...
                      <?php if($total) { ?>
                        ...
                        <!-- <form action="index.php?m=company&f=biz_design&v=make_empty" class="form-inline" method="post" target="_self"> -->
                                       ...
                                       foreach ($result as $key=>$r) { ?>
                                        ...
                                        <td class="orderlist"><img src="<?php echo getImgShownew($r['thumb'],'small_square');?>" style="height: 62px;width: 90px;" class="img-circle"></td>
                                        ...
                                        <td class="orderlist">
                                           ...
                                           <?php } ?>
                                            ...
                                            <td class="orderlist"><?php echo $r['ranks'];?></td>
                                            <td class="orderlist"><?php echo $r['mobile'];?></td>
                                            <td class="orderlist"><?php if($r['status']!=0) { ?><a href="index.php?m=company&f=biz_design&v=edit&id=<?php echo $r['id'];?>">修改</a> | <a href="index.php?m=company&f=biz_design&v=delete&id=<?php echo $r['id'];?>" id="delDesigner" class="isDel">删除</a><?php } ?></td>
                                        </tr>
                                       <?}?>
                            ...
                            <div role="tabpanel" class="tab-pane fade " id="tabs2" aria-labelledby="2tab" >
                                ...
                                <form name="myform" class="form-horizontal" action="index.php?m=company&f=biz_design&v=add" method="post" id="myform">
                                    <table class="table table-striped table-advance table-hover text-center">
                                        ...
                                        <tr>
                                            <td><div class="form-groupinfo"><label class="col-sm-2 control-label text-right text-blod"><?php if($info['star']) { ?><font color="red">*</font><?php } ?> <?php echo $info['name'];?>：</label><div class="col-sm-10 text-left" id="pp<?php echo $info['field'];?>">
                                                <?php echo $info['form'];?>
                                            </div></div></td>
                                        </tr>
                                        <?php $n++;}?>
