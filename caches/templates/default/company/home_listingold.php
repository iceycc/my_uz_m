...
<style type="text/css">
    ...
    .mon{width:100px;height:80px;float:left;margin-left:30px;}
...
padding-top:40px 
    ...
    /*装修案例样式*/
    .ContentCase *{margin:0; margin-bottom:10px;}
    ...
    .RenovationContent{height: 200px;width:100%;border-bottom:1px solid #DFDFE1;border-top:1px solid #DFDFE1;}
...
<div class="container memberframe">
    <div class="row">
                ...
                <div class="memberbordertop">
                    <section class="panel">
                        ...
                        <div style="width:100%;height:100px;margin-bottom:20px" class="phheader">
                            <!-- 公司logo -->
                            <div style="position:relative;margin-left:40px;margin-top:8px;" class="memberphoto"><img <?php if($r1['thumb']!=''){?>src="<?php echo getImgShownew($r1['thumb'],'original');?>" <?}else{?> src="http://www.uzhuang.com/res/images/upload-thumb.png"<?}?>></a></div>
        ...
        <p class="total-news"><a href="?m=messagewp&f=message&v=listing" style="color:blue;">全部消息(<?php echo $messageNum;?>)</a></p>
                        ...
                        <div class="MarginForm">
                            <span style="font-size:20px;cursor:pointer;float:right;margin-right:10px;" title="点击关闭">×</span>
                             ...
                             <?php foreach ($aCom2row as $key => $value) {?>
                                <tr>
                                  <td> <?php  echo $value['order_no'];?></td>
                                  <td><?php  echo $value['paydate'];?></td>
                                   <td><?php  echo $value['totalpay'];?></td>
                                </tr>
                            <?php  }?>
                                    <tr>
                                        <td colspan="3">合计:  <?php 
                        ...
                        <div style="margin-bottom:5px;" class="ContentCase">
                            ...
                            <div class="RenovationContent" >
                                <div class="createCase" style="margin-top:28px;"><a href="index.php?m=company&f=biz_photo&v=add#tabs2">
                                    <img src="<?php echo R;?>images/case.png" alt="" ></a>
                                </div>
                                <div id="dv1">
                                 <?php if(count($result2)!=0) {?>
                                  <?php foreach ($result2 as $key=>$r) { ?>
                                  <div id="dv2">
                                <table id="tb1" border="1" color="red" >
                              <tr>
                                  <td id="t1" style="border:1px solid #DFDFE1;"><img src="<?php echo getImgShownew($r['thumb'],'small');?>" style="max-height: 80px;max-width: 80px;" class="img-circle"></td>
                              </tr>
                                <tr>
                                  <td id="t2" style="border:1px solid white;"><?php echo $r['title'];?></td>
                              </tr>
                              ...
                              <?}?>
                               <?} else {?>
                              <table class="table table-striped table-advance table-hover text-center" style="margin-left:40px;">
                        ...
                        <div style="margin-bottom:5px;" class="ContentCase">
                            ...
                            <div class="RenovationContent">
                                <div class="createCase" style="margin-top:28px;"><a href="index.php?m=company&f=biz_design&v=listing#tabs2">
                                    <img src="<?php echo R;?>images/design.png" alt=""></a>
                                </div>
                                 <div id="dv1">
                                <?php if(count($result3)!=0) {?>
                                  <?php foreach ($result3 as $key=>$r) { ?>
                                  <div id="dv2">
                                <table id="tb1" style="border:1px solid #DFDFE1" color="red" >
                              <tr>
                                  <td id="t1"><img src="<?php echo getImgShownew($r['thumb'],'small');?>" style="max-height: 80px;max-width: 80px;" class="img-circle"></td>
                              </tr>
                                <tr>
                                  <td id="t2" style="border:1px solid white;border-top:1px solid #DFDFE1;"><?php echo $r['title'];?></td>
                              </tr>
                              <tr>
                                  <td id="t3" style="border:1px solid white;">(<?php echo $r['ranks'];?>)</td>
                              </tr>
