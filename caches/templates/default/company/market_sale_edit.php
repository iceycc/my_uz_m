                ...
                <div class="memberbordertop">
                    <section class="panel">
                        ...
                        <ul id="myTab" class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation" class="active"><a href="#tabs2" role="tab" id="2tab" data-toggle="tab" aria-controls="tabs2" aria-expanded="false">修改优惠活动</a></li>
                            </li>
                        </ul>
                        ...
                        <div id="myTabContent" class="tab-content tabsbordertop">
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="tabs1" aria-labelledby="1tab">
                                ...
                                <form name="myform" class="form-horizontal" action="index.php?m=company&f=biz_market_sale&v=edit" method="post" id="myform">
                                    <table class="table table-striped table-advance table-hover text-center">
                                        <tr>
                                            <td><div class="form-groupinfo"><label class="col-sm-2 control-label text-right text-blod"><font color="red">*</font> 图集名称：</label><div class="col-sm-4 text-left">
                                                <input type="text" style="color:#" name="form[title]" id="title" maxlength="50" value="<?php echo $data['title'];?>" class="form-control" datatype="*2-50" nullmsg="设计师姓名" errormsg="设计师姓名至少2个字符,最多50个字符！">                                       </div></div></td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td><div class="form-groupinfo"><label class="col-sm-2 control-label text-right"> </label><div class="col-sm-3 text-left">
