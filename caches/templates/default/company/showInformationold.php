...
<!-- 公司资质信息 -->
        ...
        <tr class="border-both">
            <td><div class="form-groupinfo"><label class="col-sm-3 control-label text-right"><font color="red">*</font> 营业执照扫描件：</label><div class="col-sm-7 text-left"><div class="input-group"><script src="http://www.uzhuang.com/res/js/dialog/dialog-plus.js"></script><script type="text/javascript" src="http://www.uzhuang.com/res/js/json2.js"></script><script type="text/javascript" src="http://www.uzhuang.com/res/js/html5upload/plupload.full.min.js"></script><script type="text/javascript" src="http://www.uzhuang.com/res/js/html5upload/extension.js"></script><input disabled="disabled" type="text" value="<?php echo $r['thumb'];?>" ondblclick="img_view('?m=core&amp;f=image_privew&amp;imgurl='+this.value);" class="form-control" id="thumb" name="form[thumb]" size="100" datatype="*" sucmsg="OK" errormsg="请上传营业执照" nullmsg="请上传营业执照！"><span class="input-group-btn"></span></div><span class="tablewarnings"></span></div></div></td>
        </tr>
        ...
        <tr class="border-both">
            <td><div class="form-groupinfo"><label class="col-sm-3 control-label text-right"><font color="red">*</font> 法人身份证扫描件：</label><div class="col-sm-7 text-left"><div class="input-group"><input disabled="disabled" type="text" value="<?php echo $r['LegalCardId'];?>" ondblclick="img_view('?m=core&amp;f=image_privew&amp;imgurl='+this.value);" class="form-control" id="LegalCardId" name="form[LegalCardId]" size="100" datatype="*" sucmsg="OK" errormsg="请上传法人身份证扫描件" nullmsg="请上传法人身份证扫描件！"><span class="input-group-btn"></span></div><span class="tablewarnings"></span></div></div></td>
        </tr>
        ...
        <tr class="border-both">
            <td><div class="form-groupinfo"><label class="col-sm-3 control-label text-right"><font color="red">*</font> 组织机构代码证扫描件：</label><div class="col-sm-7 text-left"><div class="input-group"><input disabled="disabled" type="text" value="<?php echo $r['orgimg'];?>" ondblclick="img_view('?m=core&amp;f=image_privew&amp;imgurl='+this.value);" class="form-control" id="orgimg" name="form[orgimg]" size="100" datatype="*" sucmsg="OK" errormsg="图片格式为.gif .jpg .peg .png .bmp" nullmsg="请上传组织机构代码证扫描件！"><span class="input-group-btn"></span></div><span class="tablewarnings"></span></div></div></td>
        </tr>
        ...
        <tr class="border-both">
            <td><div class="form-groupinfo"><label class="col-sm-3 control-label text-right"><font color="red">*</font> 税务登记证扫描件：</label><div class="col-sm-7 text-left"><div class="input-group"><input disabled="disabled" type="text" value="<?php echo $r['swdj'];?>" ondblclick="img_view('?m=core&amp;f=image_privew&amp;imgurl='+this.value);" class="form-control" id="swdj" name="form[swdj]" size="100" datatype="*" sucmsg="OK" errormsg="请上传税务登记证扫描件" nullmsg="请上传税务登记证扫描件！"><span class="input-group-btn"></span></div><span class="tablewarnings"></span></div></div></td>
        </tr>
                        ...
                        $.each(data,function(serArea,serAreaObj){
                            if (thumb&&userStatus!=4) {
                                if ($.inArray(serAreaObj.lid,res)>-1) {
                                    $(".serviceArea").append("<input name='form[areaids][]' type='checkbox' checked='checked' value='"+serAreaObj.lid+"'>"+serAreaObj.name+"</label><label class='checkbox-inline'>");
                                }else{
                                    $(".serviceArea").append("<input name='form[areaids][]' type='checkbox' value='"+serAreaObj.lid+"'>"+serAreaObj.name+"</label><label class='checkbox-inline'>");
                                }
                            }else{
                                if ($.inArray(serAreaObj.lid,res)>-1) {
                                    $(".serviceArea").append("<input name='form[areaids][]' type='checkbox' checked='checked' value='"+serAreaObj.lid+"'>"+serAreaObj.name+"</label><label class='checkbox-inline'>");
            ...
            success:function(data){
                ...
                $.post("index.php?m=company&f=biz_setting&v=companyThreeLevel",{'pid':conPid},function(datac){
                    ...
                    $.each(datac,function(ctr,ctrObj){
                        ...
                        $(".serviceArea").append("<input name='form[areaids][]' class='serArea' type='checkbox' value="+ctrObj.lid+">"+ctrObj.name+"<label class='checkbox-inline'></label>");
                    })
                },'json')
            },
            async:true
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                $.each(data,function(country,countryObj){
                    $(".serviceArea").append("<input name='form[areaids][]' class='serArea' type='checkbox' value='"+countryObj.lid+"'>"+countryObj.name+"</label><label class='checkbox-inline'>");
                })
            },
            error:function(){
                // alert("error")
