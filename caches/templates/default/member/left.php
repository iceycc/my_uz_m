...
<!--个人 -->
<div class="memberleftmenu">
<div class="menutitle text-center"><i class="ordericon"></i>精品案例</div>
 <ul>
 <li class="<?php if(M=='company' && F=='biz_photo' && V=='listing') { ?>menuactive<?php } ?>"><a href="index.php?m=company&f=biz_photo&v=listing">案例列表页</a></li>
 <li class="<?php if(M=='company' && F=='biz_photo' && V=='screen') { ?>menuactive<?php } ?>"><a href="index.php?m=company&f=biz_photo&v=screen">筛选页</a></li>
 <li class="<?php if(M=='company' && F=='biz_photo' && V=='pinyin1') { ?>menuactive<?php } ?>"><a href="index.php?m=company&f=biz_photo&v=pinyin1">筛选页</a></li>
 </ul>
