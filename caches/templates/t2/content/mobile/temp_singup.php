...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo R;?>msite/temp_singup/css/temp_singup.css">
...
<header>
    ...
    <h1 class="header-title">盛夏家装狂欢报名</h1>
</header>
<div class="singup">
...
<script src="<?php echo R;?>msite/temp_singup/js/temp_singup.js"></script>