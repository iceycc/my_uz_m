        ...
        <script type="text/template" id="mysite-title-templete">
            ...
            <div class="mysite_title_order">
                ...
                <ul class="mysite_info">
                    ...
                    <% if(titnewnode.budget > 0){ %>
                        <li><%= titnewnode.budget %>万</li>
                    <% } %>
                            ...
                            <item.companyname.length
                                ...
                                <li>
                                    <a href="mobile-company_detail.html?company_id=<%= itemcompany.col1 %>">
                                        <p><%= itemcompany.col2 %></p>
                                        <span style="color: #999"><%= itemcompany.date1 %></span>
                                    </a>
                                </li>
                                <% } %>
                        </ul>
                    ...
                    <div class="review">
                        ...
                        <% if(item.pay.length > 0){ %>
                            <% if(item.pay[0].nodename == '签订意向定金'){ %>
                                <p class="review_tit textcenter"><%= item.pay[0].nodename %></p>
                            ...
                            <% }else{ %>
                                ...
                                <div class="review_tit color999 margintop05">
                                    ...
                                    <p>协议编号：<%= item.pay[0].designno %></p>
                                    <% } %>
                                    <% if(item.pay[0].designpay){ %>
                                    <p>设计协议总金额：<%= item.pay[0].designpay %></p>
                                    <% } %>
                                    <p>已付款：<%= item.pay[0].needmoney %>元</p>
                                </div>
                            <% } %>
            ...
            <div class="zxnode_list_cont" id="snode5">
                <script type="text/template" id="snode5-cont-template">
                    ...
                    <div class="review">
                        ...
                        <% } %>
                        <div class="margintop1" style="margin-top:2.5rem;">
                            <% if(item.pay.length > 0){ %>
                                <div class="review_tit color999 margintop05">
                                    <p>付款比例：<%= item.pay[0].payment_name %></p>
                                    <p>已付款：<%= item.pay[0].needmoney %></p>
                                </div>
                            <% } %>
                        </div>
...
<!--<section class="alert_points_text">发表完成</section>-->
</body>
</html>
<!--评论模块-->
...
<script src="<?php echo R;?>msite/building_live_new/js/building_new.js"></script>
<script src="<?php echo R;?>msite/building_live_new/js/mysite.js"></script>
