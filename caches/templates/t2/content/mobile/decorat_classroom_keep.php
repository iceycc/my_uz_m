...
<link href="<?php echo R;?>msite/decorat-classroom-keep/css/post_form.css" rel="stylesheet" type="text/css">
<link href="<?php echo R;?>msite/decorat-classroom-keep/css/master.css" rel="stylesheet" type="text/css">
...
<body id="managerPage">
    ...
    <!--video-->
    <span style="display: none;" class="iframe_src">http://player.youku.com/embed/XMTYwODMxMDUwMA==</span>
    <section class="c_video" id="youkuplayer">
    	
    	<iframe  height=498 width=510 src="http://player.youku.com/embed/XMTYwODMxMDUwMA==" frameborder=0 allowfullscreen></iframe>
    </section>
    <!--video-->
    <!--<section class="c_share">
    	<ul class="c_share_btn">
    		<li class="c_share_btn_first"></li>
    		<li class="c_share_btn_sec"></li>
    	</ul>
    </section>-->
    <section class="c_choose">
		<ul class="c_choose_btn">
			...
			<li class="collection_button">
				...
				<span class="c_collection">收藏</span>
			</li>
		</ul>
	</section>
    ...
    <!--简介 start-->
    <section class="c_blurb">
    	<img src="<?php echo R;?>msite/decorat-classroom-keep/img/blurb.jpg" alt="" />
    </section> 
    <!--简介 end-->
    <!--现场详情 start-->
    <section class="c_details">
    	<img src="<?php echo R;?>msite/decorat-classroom-keep/img/image1.jpg" alt="" />
    	<div class="c_details_mask">
    		<p>管家在水电现场</p>
    		<a href="mobile-building_live_water.html">查看工地详情>></a>
    	</div>
    </section>
    <!--现场详情 end-->
    <section class="c_app_download">
    	<div class="c_team">
    		<a href="http://b.uzhuang.com/">
    			<img src="<?php echo R;?>msite/decorat-classroom-keep/img/tiem.jpg" alt="" />
    		</a>
    	</div>
    	<div class="c_zgapp_download">
    		<img src="<?php echo R;?>msite/decorat-classroom-keep/img/zg-download.jpg" alt="" />
    		<a href="https://itunes.apple.com/cn/app/zhuang-xiu-bang-bang-bang/id1106829016?mt=8" class="c_zgapp_download_btn">点击下载</a>
    	</div>
    </section>
    <!--footer_menu start-->
    <section class="footer_menu_bs">
    	...
    	<div  onclick="_hmt.push(['_trackEvent', 'div', 'click'])" class="amount_house_bs">
    		<p class="amount_house_bs_text">预约管家</p>
    	</div>
    </section>
    <!--footer_menu end-->
    ...
    <div class="in_info_bs">
    	...
    	<p class="in_title_name_bs">装修等什么，快来预约管家吧，贼靠谱！</p>
    	<div id="apply-form">
            <form name="myform" method="post" id="myform">
                ...
                <input id="applyBtn" class="orange-btn" type="submit" value="预约管家">
                <input id="source" type="hidden" value="M站-装修课堂活动页">
            </form>
    ...
    <!--amount_house_mask end-->
    
    <!--各种遮罩层s-->
    <div class="weixin_share"><div class="weixin_share_close"></div></div>
  	
  	<div class="download_mask"><div class="download_mask_close"></div></div>
  	
  	 <div class="mask_android">
		<div class="mask_android_bg">
			<img src="<?php echo R;?>msite/decorat-classroom-keep/img/Android_prompt.png" alt="Android火热开发中" />
		</div>
		<div class="mask_android_close">我知道了</div>
	</div>
    <!--各种遮罩层e-->
    
    <!--收藏成功s-->
  	<div id="showBox" style="display: none;">
  		<span id="showInfo">收藏成功</span>
  	</div>
...
<script src="<?php echo R;?>msite/base/js/send_formM2.1.js"></script>
<script src="<?php echo R;?>msite/decorat-classroom-keep/js/index.js"></script>
<script src="<?php echo R;?>msite/decorat-classroom-keep/js/size.js"></script>
<script>
	$(function(){
