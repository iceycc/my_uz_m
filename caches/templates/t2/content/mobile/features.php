...
<div id='share_logo' style='margin:0 auto;display:none;'> 
  <img src="<?php echo R;?>msite/base/img/share_logo.jpg"/> 
    ...
    <header> 
      ...
      <h1 class="header-title">特色服务</h1>
      
    </header>

    <!--Form Start-->
    <section id="feature-form">
    	<div id="apply-banner">
   	    	<img src="<?php echo R;?>msite/application/img/features/features_02.jpg"/>
            <img src="<?php echo R;?>msite/application/img/features/features_03.jpg"/>
            <img src="<?php echo R;?>msite/application/img/features/features_04.jpg"/>
            <img src="<?php echo R;?>msite/application/img/features/features_05.jpg"/>
            <img src="<?php echo R;?>msite/application/img/features/features_06.jpg"/>
        </div>
    	<div id="apply-form">
