...
<script type="text/template" id="common-data">
    <% for(var key in module){ %>
        ...
        <% } else { %>
            ...
            <% if(applybox == 1){ %>
                <% if(item.caset == "apply"){ %>
                    <div id="apply-form" style="background: url(<%= item.background %>) no-repeat 0 0/cover;">
                        <form name="myform" method="post" id="myform" >
                            <div id="name-box">
                                <input id="user-name" name="title" class="apply-input" type="text" maxlength="10" placeholder="您的姓名">
                            </div>
                            ...
                            <% if(item.are == 1){ %>
                                <div id="area-choose" class="user-info fix">
                                    <div id="province">
                                    <select  name="select-01" id="select-01" class="open-city">
                                        <option value="0">省/市</option>
                            ...
                            <% } %>
                            <input id="applyBtn" class="orange-btn" type="submit" value="<%= item.submitcopy %>" style="background-color: <%= item.buttoncolor %>; color: <%= item.buttoncopycolor %>">
                            <input id="source" name="source" type="hidden" size="30" value="活动报名页">
                        </form>
                        <p id="apply-total" class="total" style="color: <%= item.cuewords %>">已有<em class="number" id="userTotal" style="color: <%= item.numbercolor %>"><%= item.tosignup %></em>人参加</p>
                    </div>
                <% } %>
            <% } %>
            </li>
