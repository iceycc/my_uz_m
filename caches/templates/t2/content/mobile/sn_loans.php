...
<header>
	...
	<h1 class="header-title">苏宁金融</h1>
</header>
<section class="banner">
	<img src="<?php echo R;?>msite/loans_calculator/img/sn_banner.jpg" alt="banner图" />
</section>
<section class="apply-form">
	<img src="<?php echo R;?>msite/loans_calculator/img/sn_img1.jpg" alt="" />
	<a class="first-btn" href="http://m.uzhuang.com/mobile-template.html?temp=150&id=snjr">我要贷款</a>
	<div class="sn-form-box form-box">
		<div class="one-con">
			<form>
				<div class="num-box">
					<span>贷款金额</span>
				...
				<input type="button" id="sn-apply-sub" class="btn-style" value="算一算" />
			</form>
		...
		<div class="two-con">
			...
			<a href="http://m.uzhuang.com/mobile-template.html?temp=150&id=snjr">我要贷款</a>
		</div>
	</div>
</section>
<section>
	<img src="<?php echo R;?>msite/loans_calculator/img/sn_img3.jpg" alt="" />
	<img src="<?php echo R;?>msite/loans_calculator/img/sn_img4.jpg" alt="" />
	<img src="<?php echo R;?>msite/loans_calculator/img/sn_img5.jpg" alt="" />
	<img src="<?php echo R;?>msite/loans_calculator/img/sn_img6.jpg" alt="" />
</section>
<a href="http://m.uzhuang.com/mobile-template.html?temp=150&id=snjr" class="bottom-link">我要贷款</a>
