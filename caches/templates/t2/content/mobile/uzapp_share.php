...
<link href="<?php echo R;?>msite/uz_app/css/uzapp_share.css" rel="stylesheet" type="text/css">
...
<section id="article-box" class="share-article">
    ...
    <div class="time-words">
        <span class="time">2016-01-12 19:00</span>
        <span>优装美家</span>
    ...
    <div class="detail-content">
        ...
        <img src="<?php echo R;?>msite/uz_app/img/art_img.jpg" alt="" />
        <p>厨房在水电改造的时候，主要的电器就是水龙头和热水器，而且基本上只要家里面积不是太大。</p>
        <p>厨房在水电改造的时候，主要的电器就是水龙头和热水器，而且基本上只要家里面积不是太大，厨房和卫生间都是使用同一个热水器的，所以很关键的就是热水器的安装位置了，确定了它的安装位置，才能进行水路改造。</p>
    </div> -->
</section>
<section>
    <div class="download-app">
        <a href="https://itunes.apple.com/cn/app/you-zhuang-mei-jia/id1121866675?l=zh&ls=1&mt=8">
            <img class="download-icon" src="<?php echo R;?>msite/uz_app/img/uz_app_download.png" alt="" />
        </a>
    </div>
</section>
...
<script type="text/template" id="article-data">
    <% for(var i=0; i<data.length; i++){ %>
        ...
        <div class="time-words">
            ...
            <span>优装美家</span>
            <p><strong>导语：</strong><%= item.remark %></p>
        </div>
        <div class="detail-content">
            <%= item.content %>
        </div>
...
<script type="text/javascript" src="<?php echo R;?>msite/uz_app/js/uzapp_share.js"></script>
</body>
</html>