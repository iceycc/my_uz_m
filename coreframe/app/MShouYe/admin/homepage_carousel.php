              ...
              if($keytypess==1){
               $where="status='1'";
                ...
                $where="status='3'";
                 ...
                 $result = $this->db->get_list('m_carousel',$where, '*', 0, 10,$page,'updatetime DESC,sort DESC');
          }else if($keytypes==1){
                $where.=" and title like  '%".$GLOBALS['title']."%'";
                if($GLOBALS['pai']=="tshang"){
                       $result = $this->db->get_list('m_carousel',$where, '*', 0, 10,$page,'updatetime ASC');
                  }else if($GLOBALS['pai']=="txia"){
                       $result = $this->db->get_list('m_carousel',$where, '*', 0, 10,$page,'updatetime DESC');
                  }else if($GLOBALS['pai']=="gshang"){
                       $result = $this->db->get_list('m_carousel',$where, '*', 0, 10,$page,'intervene ASC');
                  }else if($GLOBALS['pai']=="gxia"){
                       $result = $this->db->get_list('m_carousel',$where, '*', 0, 10,$page,'intervene DESC');
                  }else{
                       $result = $this->db->get_list('m_carousel',$where, '*', 0, 10,$page,'updatetime DESC,sort DESC');
                  }
          }else if($keytypes==2){
    ...
    public function add(){
        ...
        if(isset($GLOBALS['submit']) || isset($GLOBALS['submit2'])) {
            ...
            if($GLOBALS['submit']=="发布"){
                    ...
                    $formdata['zhu_carousel'] = remove_xss(basename($GLOBALS['form']['zhu_carousel']));
                  ...
                  if($GLOBALS['submit']=="发布"){
                    ...
                    $formdata['cid'] = 222;
                               $formdata['title'] = remove_xss($GLOBALS['title']);
                                ...
                                $formdata['zhu_carousel'] = remove_xss(basename($GLOBALS['zhu_carousel']));
                                $formdata['updatetime'] = empty($GLOBALS['form']['updatetime']) ? SYS_TIME : strtotime($GLOBALS['form']['updatetime']);
