<form name="myform" class="form-horizontal tasi-form" id="form6" action="?m=MShouYe&f=homepage_photo&v=intervenes&id=<?php echo $result['id']?><?php echo $this->su();?>" method="post">
