...
$(":button:contains(重复检测)").remove();
 var tip='<span style="position: relative;top: -25px;left: 310px;"><font size="2">(宽度640px,高度293px;双击可预览图片)</font></span>';
 $(".hidden-phone:eq(2)>.input-group").after(tip)

 var tip2='<span style="position: relative;top: -25px;left: 310px;"><font size="2">(宽度640px,高度321px;双击可预览图片)</font></span>';
 $(".hidden-phone:eq(3)>.input-group").after(tip2)

 var tip1='<span style="position: relative;top: -25px;left: 310px;"><font size="2" color="#f34a4a">(链接以“http://”打头)</font></span>';
 $(".hidden-phone:eq(4)>.input-group").after(tip1);
