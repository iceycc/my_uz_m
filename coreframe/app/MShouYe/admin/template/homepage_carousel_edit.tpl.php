...
<div role="tabpanel" class="tab-pane fade active in" id="tabs1" aria-labelledby="1tab">
      <form action="?m=MShouYe&f=homepage_carousel&v=edit<?php echo $this->su();?>" class="form-inline" method="post">
        <div class="input-group">
           
              <font size="2px" style="float:left"><span style="color:red">*</span><b>标题：&nbsp;&nbsp;&nbsp;</b></font> 
             <input class="input1" name="title" value="<? echo $re['title']?>" >
             <br/><br/>
                 <font size="2px" style="float:left"><span style="color:red">*</span><b>城市：&nbsp;&nbsp;&nbsp;</b></font> 
                  <?php $city=get_config('city_config');
                 foreach ($city as $key => $value) {?>     
                    <input type="checkbox" value="<?php echo $value['cityid'];?>" name="city[]" class="input3" <?php if(in_array($value['cityid'],explode(',',$re['city']))){echo "checked='checked'";}?>><?php echo $value['city'];?>
                 <?}?>
            <br/><br/>
                 <span style="float:left;"><font style="color:red" size="2px">*</font><b><font size="2px">M站轮播图:</font></b>&nbsp;&nbsp;&nbsp;</span><input type="text" value="<?php echo $re['carousel'];?>" ondblclick="img_view('?m=core&f=image_privew&imgurl='+this.value);" class="form-control" id="attachment_test" name="attachment_test" size="100" style="width:450px;margin-right:5px;position:relative;">
                 <font size="2px" style="float:left">
                <span class="input-group-btn">
                <button type="button" class="btn btn-white" onclick="openiframe('/index.php?m=attachment&amp;f=index&amp;v=upload_dialog&amp;callback=callback_thumb_dialog&amp;htmlid=attachment_test&amp;limit=1&amp;htmlname=setting%5Battachment_test%5D&amp;ext=png%7Cjpg%7Cgif%7Cdoc%7Cdocx&amp;token=3d9292f4c141b7f9c4f3a37f8af2e607&amp;_menuid=29&amp;_submenuid=67','attachment_test','loading...',810,400,1)" id='button1'>上传文件</button>
                </span>
                <span style="position: relative;top: -21px;left: 90px;"><font size="2">(宽度640px,高度293px;双击可预览图片)</font></span>
                </font>
            <br/><br/>
                <span style="float:left;"><font style="color:red" size="2px">*</font><b><font size="2px">app轮播图:</font></b>&nbsp;&nbsp;&nbsp;</span><input type="text" value="<?php echo $re['zhu_carousel'];?>" ondblclick="img_view('?m=core&f=image_privew&imgurl='+this.value);" class="form-control" id="zhu_carousel" name="zhu_carousel" size="100" style="width:450px;margin-right:5px;position:relative;">
                 <font size="2px" style="float:left">
                <span class="input-group-btn">
                <button type="button" class="btn btn-white" onclick="openiframe('/index.php?m=attachment&amp;f=index&amp;v=upload_dialog&amp;callback=callback_thumb_dialog&amp;htmlid=zhu_carousel&amp;limit=1&amp;htmlname=setting%5Bzhu_carousel%5D&amp;ext=png%7Cjpg%7Cgif%7Cdoc%7Cdocx&amp;token=3d9292f4c141b7f9c4f3a37f8af2e607&amp;_menuid=29&amp;_submenuid=67','zhu_carousel','loading...',810,400,1)" id='button1'>上传文件</button>
                </span>
                <span style="position: relative;top: -21px;left: 90px;"><font size="2">(宽度640px,高度321px;双击可预览图片)</font></span>
                </font>
            <br/><br/>
               <font size="2px" style="float:left"><span style="color:red">*</span><b>链接地址：&nbsp;&nbsp;&nbsp;</b></font> 
               <input class="input2" name="address" value="<? echo $re['address']?>" style="width:450px;"> <font size="2" color="#f34a4a">(链接以“http://”打头)</font>
            <br/><br/>
...
<script type="text/javascript">
 $(document).ready(function(){
      ...
      $(".input2").css({'border':'1px solid #E2E2E4','font-size':'15px'});
       $("#attachment_test").css({'border':'1px solid #E2E2E4','font-size':'15px','height':'25px'});
       $("#zhu_carousel").css({'border':'1px solid #E2E2E4','font-size':'15px','height':'25px'});
       $("#button1").css({'height':'25px','padding-top':'2px'});
