                ...
                foreach($formdata['0'] as $field=>$info) {
                    ...
                    <tr>
                        ...
                        <td class="hidden-phone" >
                            <div class="col-sm-12 input-group" style="width: 250px;">
                                <?php echo $info['form']?>
...
$(":button:contains(重复检测)").remove();
 var tip='<span style="position: relative;top: -25px;left: 310px;"><font size="2">(宽度600px,高度188px;双击可预览图片)</font></span>';
 $(".hidden-phone:eq(2)>.input-group").after(tip)

 var tip1='<span style="position: relative;top: -25px;left: 310px;"><font size="2" color="#f34a4a">(链接以“http://”开头)</font></span>';
 $(".hidden-phone:eq(3)>.input-group").after(tip1);

 $(document).ready(function(){
    $(".checkbox-inline:eq(0)").prev().attr("name","");
 })
