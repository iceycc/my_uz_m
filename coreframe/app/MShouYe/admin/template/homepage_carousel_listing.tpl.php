                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <th class="textName" style="padding-left:40px;padding-right:20px;"><h5>序号</h5></th>
                                 <th class="textName"style="padding-left:20px;"><h4><p class="collect">干预值</p></h4><br/>
                                  <a href="?m=MShouYe&f=homepage_carousel&v=listing&cid=222&pai=gshang&keytypes=<?php echo $keytypes;?>&title=<?php echo $GLOBALS['title'];?><?php echo $this->su();?>"class="shang1" >升</a>
                                  <a href="?m=MShouYe&f=homepage_carousel&v=listing&cid=222&pai=gxia&keytypes=<?php echo $keytypes;?>&title=<?php echo $GLOBALS['title'];?><?php echo $this->su();?>"class="xia1" >降</a>
                                </th>
                                ...
                                <th class="textName" style="padding-left:30px;"><h5>城市</h5></th>
                                 <th class="textName"style="padding-left:45px;"><h4><p class="collect">更新时间</p></h4><br/> 
                                   <a href="?m=MShouYe&f=homepage_carousel&v=listing&cid=222&pai=tshang&keytypes=<?php echo $keytypes;?>&title=<?php echo $GLOBALS['title'];?><?php echo $this->su();?>"class="shang1" >升</a>
                                   <a href="?m=MShouYe&f=homepage_carousel&v=listing&cid=222&pai=txia&keytypes=<?php echo $keytypes;?>&title=<?php echo $GLOBALS['title'];?><?php echo $this->su();?>"class="xia1" >降</a>
                                 </th>
