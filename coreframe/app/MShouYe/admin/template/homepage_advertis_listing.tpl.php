            ...
            <section class="panel">
                <header class="panel-heading">
                 ...
                 <span class="dropdown examine">
                    ...
                    <form action="?m=MShouYe&f=homepage_advertis&v=listing<?php echo $this->su();?>" class="form-inline"  method="post" id="form7">
                  ...
                  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<a href="?m=MShouYe&f=homepage_advertis&v=add&cid=270<?php echo $this->su();?>"class="btn btn-default btn-sm" >新建</a>
                <form action="?m=MShouYe&f=homepage_advertis&v=Deletes<?php echo $this->su();?>" class="form-inline"  id="form6" method="post">
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <?php foreach($result AS $key =>$Mjin) { ?>
                              ...
                              ?>
                               ...
                               <td style="padding-left:30px;"> <button style="" onclick="openiframe('?m=MShouYe&f=homepage_advertis&v=intervene&id=<?php echo $Mjin['id'];?><?php echo $this->su();?>','testaa','修改干预值',350,100);" type="button"><?echo $Mjin['intervene']?></button></td>
                              ...
                              <td> 
                              <a href="?m=MShouYe&f=homepage_advertis&v=edit&id=<?php echo $Mjin['id'];?>&cid=<?php echo $Mjin['cid'].$this->su();?>" class="btn btn-primary btn-xs">编辑</a>
                              <?php if($Mjin['status']==1){?><a href="javascript:makedo('?m=MShouYe&f=homepage_advertis&v=UnShelve&id=<?php echo $Mjin['id'];?><?php echo $this->su();?>', '确认下架该记录？')" class="btn btn-default btn-xs">下架</a><?}elseif($Mjin['status']==2){?><a href="javascript:makedo(' ?m=MShouYe&f=homepage_advertis&v=Putaway&id=<?php echo $Mjin['id'];?><?php echo $this->su();?>', '确认上架该记录？')" class="btn btn-default btn-xs">上架</a><?}elseif($Mjin['status']==3){?><a href="javascript:makedo('?m=MShouYe&f=homepage_advertis&v=Publish&id=<?php echo $Mjin['id'];?><?php echo $this->su();?>', '确认发布该记录？')" class="btn btn-default btn-xs">发布</a><?}?>
                              <a href="javascript:makedo('?m=MShouYe&f=homepage_advertis&v=delete&id=<?php echo $Mjin['id'];?><?php echo $this->su();?>', '确认删除该记录？')" class="btn btn-danger btn-xs">删除</a>
                                    </td>
                                </tr>
                                <?}?>
                            <?php }else{ ?>
...
$('.gshang').click(function(){
  ...
  $('.gshang').attr("href","?m=MShouYe&f=homepage_advertis&v=listing&cid=270&pai=gshang&keytypes="+cityid+"&status="+status+"<?php echo $this->su();?>");
})
...
$('.gxia').click(function(){
  ...
  $('.gxia').attr("href","?m=MShouYe&f=homepage_advertis&v=listing&cid=270&pai=gxia&keytypes="+cityid+"&status="+status+"<?php echo $this->su();?>");
})
// 按干预值升降 end
...
$('.tshang').click(function(){
  ...
  $('.tshang').attr("href","?m=MShouYe&f=homepage_advertis&v=listing&cid=270&pai=tshang&keytypes="+cityid+"&status="+status+"<?php echo $this->su();?>");
})
$('.txia').click(function(){
  if($('.city option[selected]').val()){
        cityid=$('.city option[selected]').val();
  ...
  $('.txia').attr("href","?m=MShouYe&f=homepage_advertis&v=listing&cid=270&pai=txia&keytypes="+cityid+"&status="+status+"<?php echo $this->su();?>");
})
// 按更新时间升降 end
  $("#deletes").click(function(){
    ...
    $("#bao1").click(function(){
    $("#form6").attr("action","?m=MShouYe&f=homepage_advertis&v=listing<?php echo $this->su();?>")
  })
    $("#form7").find("button").click(function(e){
      var form = $(e.target).parents("form");
      form.attr("action","?m=MShouYe&f=homepage_advertis&v=listing<?php echo $this->su();?>&"+form.serialize());
      form.submit();
      return false;
  })
</script>
