...
<div role="tabpanel" class="tab-pane fade active in" id="tabs1" aria-labelledby="1tab">
      <form action="?m=MShouYe&f=homepage_advertis&v=edit<?php echo $this->su();?>" class="form-inline" method="post">
        <div class="input-group">
            ...
            <?php $city=get_config('city_config');
             ...
             <span style="float:left;"><font style="color:red" size="2px">*</font><b><font size="2px">封面图:</font></b>&nbsp;&nbsp;&nbsp;</span><input type="text" value="<?php echo $re['cover'];?>" ondblclick="img_view('?m=core&f=image_privew&imgurl='+this.value);" class="form-control" id="attachment_test" name="attachment_test" size="100" style="width:450px;margin-right:5px;position:relative;">
            ...
            <span style="position: relative;top: -21px;left: 90px;"><font size="2">(宽度640px,高度293px;双击可预览图片)</font></span>
             ...
             <input class="input2" name="address" value="<? echo $re['address']?>" style="width:450px;"> <font size="2" color="#f34a4a">(链接以“http://”打头)</font><br/><br/>
        </div>
