...
class index extends WUZHI_admin {
	...
	public function listing() {
		...
		$keyArr = array(''=>'M站_注册来源','mobile'=>'M站_手机号', 'weixin'=>'M站_微信', 'qq'=>'M站_QQ', 'sina'=>'M站_微博','GAPP_mobile'=>'官App_手机','zhu_app_wx'=>'官App_微信','zhu_app_wb'=>'官App_微博','zhu_app_qq'=>'官App_QQ');
		$keyType = isset($GLOBALS['keyType']) && isset($keyArr[$GLOBALS['keyType']]) ? $GLOBALS['keyType'] : '';
		$where = '';
			if($keyType){
				$where = 'mobile_station="'.$keyType.'"';
			}else{	
		    $where='mobile_station="mobile" or mobile_station="qq" or mobile_station="weixin" or mobile_station="sina" or mobile_station="GAPP_mobile" or mobile_station="zhu_app_wx" or mobile_station="zhu_app_qq" or mobile_station="zhu_app_wb"';
			}
