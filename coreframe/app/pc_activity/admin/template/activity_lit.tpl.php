                ...
                <header class="panel-heading">
                  ...
                  &nbsp;&nbsp;&nbsp; &nbsp; 
                   <button class="btn btn-default btn-sm" onclick="openiframe('?m=pc_activity&f=activity&v=createActivity<?php echo $this->su();?><?php echo $this->su();?>','testaa','基础信息模块',800,600);" type="button">创建新活动</button>
                    <form action="?m=pc_activity&f=activity&v=lst<?php echo $this->su();?>" class="form-inline"  method="post">
                       ...
                       <table class="table table-striped table-advance table-hover">
                           ...
                           <tbody>
                              <?php foreach ($res as $key => $re) { ?>
                                  ...
                                  <?php $mz = "" ?>
                                  <?php if($re['pczhu'][0]){?>
                                      <?php  $pc =  count($re['pczhu']); ?>
                                  <?php }else{?>
                                      <?php  $pc = 0; ?>
                                  <?php }?>
                                  <?php if($re['mzhu'][0]){?>
                                      <?php  $mz =  count($re['mzhu']); ?>
                                  <?php }else{?>
                                      <?php  $mz = 0; ?>
                                  <?php }?>
                                <tr class="showTr">
...
<script>
    var SCOPE = {
        'status_url' : '?m=pc_activity&f=activity&v= <?php echo $this->su();?>',
