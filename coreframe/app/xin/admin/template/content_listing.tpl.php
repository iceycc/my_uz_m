        ...
        <div class="col-lg-12">
          ...
          <!--           <form class="pull-right position" action="" method="get">
              ...
              <!--     &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<a href="?m=xin&f=content&v=adds&cid=39<?php echo $this->su();?>"class="btn btn-default btn-sm" >添加活动</a> -->
                  ...
                  &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;<a href="?m=xin&f=oldcontent&v=listing&cid=39<?php echo $this->su();?>"class="btn btn-default btn-sm" >旧模板</a>
                  <br/>
                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <?php foreach($result AS $key =>$Mjin) { ?>
                             ...
                             <? $str=R;$newstr = substr($str,0,strlen($str)-5);?>
                               <a href="mobile-template_new.html?hid=<?echo $Mjin['id']?>" target="_blank">
                                <!-- <div  class="test_demo_ellipsis" style="text-overflow:ellipsis;"> -->
                                     <?php echo $Mjin['activityname'];?>
                                     <!-- </div> -->
                               </a>
                               </td>
                               <td style="padding-left:30px;"><?php echo date('Y-m-d H:i:s',$Mjin['uptime'])?></td>
                               <td style="padding-left:30px;"><?php 
                               $str=R;$newstr = substr($str,0,strlen($str)-5);$url='uploadfile/wei/'.$Mjin['id'].".png";
                               echo $newstr.'/mobile-template_new.html?hid='.$Mjin['id'];?><img class="xiaotu" src="<?echo $url?>" style="width:30px;" onClick="img_wei(this.src);"><a href="?m=xin&f=content&v=doDownload&filename=<?echo $url?><?php echo $this->su();?>">下载二维码</a></td>
                               <td style="padding-left:30px;"><?php 
                                    $arr=array('1'=>'上线','2'=>'下线','3'=>'未发布');
                                    echo $arr[$Mjin['status']];
                               ?></td>
                              <td> 
