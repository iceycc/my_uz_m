            ...
            <section class="panel">
              ...
              <div class="exercise">
                ...
                <table class="table table-striped table-advance table-hover">
                   ...
                   <tr>
                     <th>
                       <font ><span style="color:red">*</span>活动名称</font>: <input type="text" name="title" id='name' class="input" style="height:35px; width:300px; " placeholder="描述（建议1-8字符之间）"value="">
                     </th>
                   </tr>
                   <tr >
                    <th>
                    ...
                    <th>
                      <font >视频页</font>:
                         <span style="color:red" class='H5'>640*330</span>
                      <span style="color:red" class='ISH5'>640*1136</span>
                      <div class="attaclist"><div id="cases"><ul id="case_ul"></ul></div><span class="input-group-btn">
                         ...
                         <span  class='H5'>
                           <input type="radio" name="sx" value="1" checked="">上&nbsp;&nbsp;&nbsp;
                           <input type="radio" name="sx" value="2" >下
                         </span>
                          <font style="margin-left: 30px;"><input type="checkbox" name="advertising" value="1" style="margin-left:5px;position: relative;top: 2px;" />去广告(清谨慎勾选,点击是要花钱的)</font> 
                    </th>
                   </tr>
                   <tr>
                     <th>
                    ...
                    <tr class="H5">
                     ...
                     <tr>
                       <th> <font color='red'>是否显示报名区域</font>: 
                                <input type="radio" name="isno" class="is" value="1" checked="">是&nbsp;&nbsp;&nbsp;
                                <input type="radio" name="isno" class="no" value="2" >否
                       </th>
