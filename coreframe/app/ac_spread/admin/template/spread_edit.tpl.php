...
<section class="wrapper">
    <div class="row">
        <section class="panel">
          <form class="form-horizontal tasi-form" method="post" action="?m=pc_activity&f=activity&v=activityEdit<?php echo $this->su();?>" >
               <div class="head">
               	   <span >
               	     <center>
               	    ...
               	    <div class="layui-form-label">
				         ...
				         <span style='margin-left: 10px;'> 
			                  <input name="activity_type" type="radio" class="radio" value="1" <?php if($arr['activity_type']==1){echo 'checked';}?>/><i style="line-height: 24px;">标准</i>
			                  <input name="activity_type" type="radio" class="radio" value="2" <?php if($arr['activity_type']==2){echo 'checked';}?>/><i style="line-height: 24px;">特殊</i>
			             </span> 
				   </div><br/>
               	   <div class="layui-form-label">
				         <label class="labelr" style="margin-left:10px;">SEO关键词</label>
				         <input type="text" name="seo_keyword" id='seo_keyword' class="input" placeholder="如：优装网，生活家，全包活动" value="<?php echo $arr['seo_keyword']?>" style="height: 30px;width:806px;"><span style="color:red">一般不能超过100个字符</span>              
				   </div>
				   <div class="layui-form-label">
				         <label class="labelr" style="margin-left:10px;">SEO描述</label>
				         <textarea style="width:800px;" name="seo_description" id="seo_description" placeholder="如：优装美家德系整装是优装美家与生活共同合作推出，是一款利率超低、额度高、期限灵活、免抵押免担保，专门为用户解决装修资金周转的装修货款分期厂品"  ><?php echo $arr['seo_description']?></textarea><span style="color:red">一般不能超过200个字符</span>        
				   </div>
               </div>
               <div class="banner">
               	   <div class="layui-form-label">
				   ...
				   <div class="layui-form-label" style="margin-top:10px;">
				         ...
				         <input type="text" name="banner_width" id='banner_width' class="input" placeholder="1800" value="<?php echo $arr['banner_width']?>" style="height: 30px;width:60px;">  
				         ...
				         <input type="text" value="<?php echo $arr['banner']?>" ondblclick="img_view(this.value);" class="form-control" id="banner" name="banner" size="100" style="width:230px;margin-right:5px;position:relative;" placeholder="背景640*430px" > 
				         ...
				         <input type="text" name="banner_color" id='banner_color' class="input" placeholder="#259add" value="<?php echo $arr['banner_color']?>" style="height:30px;width:100px;">  
				   </div>
               </div>
               <div class="content">
               	   <div class="layui-form-label" style="margin-top:10px;">
                         ...
                         <table class="table table-striped table-advance table-hover">
                            <tr>
                              <td style="width:5%;"> 
                                 ...
                                 <input type="hidden" name="form[content][ids][]" value="<? echo $va['ids']?>" class="ids">
                                 <img src="<?php echo getMImgShow($va['picimg'],'original')?>" alt="'+file_alt+'" onclick="img_viewss(this.src);" style="margin-left:50px;height:60px;"></td>
                                 <td style="width:10%"> 
                                 <input style="" type="hidden" name="form[content][picimg][]" value="<?php echo $va['picimg']?>">
                                 <input type="text" name="form[content][color][]" style="width:50%;height: 30px;" placeholder="颜色值" value="<?php echo $va['color']?>" class="forbid">
                                 </td>
                                 <td style="width: 10%">
               ...
               <div class="bidding">
				   ...
				   <div class="layui-form-label" style="margin-top:10px;">
				     ...
				     <input type="text" value="<?php echo $arr['bidding']?>" ondblclick="img_view(this.value);" class="form-control" id="bidding" name="bidding" size="100" style="width:230px;margin-right:5px;position:relative;" placeholder="背景640*430px" > 
				    ...
				    <input type="text" name="bidding_color" id='bidding_color' class="input" placeholder="#259add" value="<?php echo $arr['bidding_color']?>" style="height:30px;width:100px;">
                 </div>
                 <div class="layui-form-label" style="margin-top:10px;">
				     <label class="labelr">发标左侧图上传</label>
				     <input type="text" value="<?php echo $arr['left_pic']?>" ondblclick="img_view(this.value);" class="form-control" id="left_pic" name="left_pic" size="100" style="width:230px;margin-right:5px;position:relative;" placeholder="背景640*430px" > 
				    ...
				    <input type="text" name="left_pic_color" id='' class="input" placeholder="#259add" value="<?php echo $arr['left_pic_color']?>" style="height:30px;width:100px;">
                 </div>
               </div>
			   <center>
			         <input type="hidden" value="<?php echo $arr['id']?>" name='id'>
			         <input type="hidden" value="<?php echo $arr['sourceid']?>" name='sourceID'>
			   	    <input name="submit" type="submit" class="save-bt btn btn-infos" id="btn-save"  onclick=""  value="发布" >
			   </center>
		  </form>
        </section>
    </div>
