...
<section class="wrapper">
    <div class="row">
        <section class="panel">
			<form class="form-horizontal tasi-form" method="post" action="?m=activity&f=activity&v=edit<?php echo $this->su();?>" id="wz-form">
			  <ul  class="h5">
			     <li class='h5n'>
			             	       ...
			             	       <table class="table table-striped table-advance table-hover">
			             	          <tr>
			             	             <td style="width:100px;margin-right:18px"> 
			             	              ...
			             	              <td >
			             	                    ...
			             	                    <input type="text" name="form[activity_normal][picurl][]" value="<?php echo $va['picurl']?>" style="width:270px;height: 30px; margin-left:-30px;margin-top: 19px;" >

			             	                     <?}else{?>
                                                     <input type="hidden" name="form[activity_normal][picurl][]" value="<?php echo $va['picurl']?>" style="width:270px;height: 30px; margin-left:-30px;margin-top: 19px;" >
			             	                     <?}?>
			             	          ...
			             	          <?php if(!empty($va['shuffling'])){
			             	          	foreach ($va['shuffling'] as $k => $v) {?>
				             	               <tr class="xiao[<?php echo $va['type']?>]" gaibian="change">
						             	          <td>
							             	          ...
							             	          <input  type="hidden" name="xiao[shuffling<?php echo $va['ids']?>][shufflingpic][]" value="<?php echo $v['shufflingpic']?>" class="imgname">
						             	          </td>
						             	          <td>
						             	          		<input type="text" name="xiao[shuffling<?php echo $va['ids']?>][shufflingurl][]" value="<?php echo $v['shufflingurl']?>" style="width: 214px;height: 22px; position: absolute;left: 304px;margin-top: -16px;" placeholder="图片url连接(如:http://m.uzhuang.com)" class="urlname">
						             	          </td>
						             	          <td>
			             	           ...
			             	           <?}?>
						             	   ...
						             	   <td>
			             	              <input  type="submit" class="save-bt" onclick="goAdd(<?php echo $va['ids']?>);return false" value="继续添加" >
			             	             </td>
			             	         <?}?>
			             	       </table>
			             	  </li>
