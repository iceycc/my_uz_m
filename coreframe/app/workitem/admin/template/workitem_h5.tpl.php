...
<form class="form-horizontal tasi-form" method="post" action="?m=activity&f=activity&v=add<?php echo $this->su();?>" id="wz-form">
  <ul  class="h5">
     <li class='h5n'>
	        ...
	        <div class="layui-form-label share">
		        ...
		        <input type="text" name="activityname" id="activityname" class="input" style="margin-top:10px;"placeholder="描述（建议1-15字符之间）"  value="" ></span>
	        </div>
		    ...
		    <div class="layui-form-label headlineh" >
		         ...
		         <input type="text" name="activitytitle" id='name' class="input" placeholder="描述（建议1-8字符之间）"value="" ><img src="" class="imsy nameims" alt=""><span class='titlesy name'></span>                 
		    </div>
		    <div class="layui-form-label">
     ...
     <li class='h5n'>
	       ...
	       <div class="layui-form-label">
	         <label class="labelf" style="margin-left:10px;">报名位置</label>
	          <span style='margin-top: 10px;margin-left: 10px;'> 
	            <input name="location" type="radio" value="1"  checked="" />上
	            <input name="location" type="radio" value="2"  />下
	          </span>
	      </div>
	        <div class="layui-form-label share">
		        <label class="labelr" style="margin-left:10px;margin-top:10px;"><span class='red'>*</span>报名按钮背景文案</label>
		        <input type="text" name="copy" id="copy" class="input" style="margin-top:10px; " value="" ></span>
	        </div>
	        <div class="layui-form-label share">
		        <label class="labelr" style="margin-left:10px;margin-top:10px;"><span class='red'>*</span>报名按钮背景颜色</label>
		        <input type="text" name="color" id="color" class="input" style="margin-top:10px; " value="" ></span>
	        </div>
	        <div class="layui-form-label share">
		        <label class="labelr" style="margin-left:10px;margin-top:10px;"><span class='red'>*</span>报名按钮文案颜色</label>
		        <input type="text" name="copycolor" id="copycolor" class="input" style="margin-top:10px; " value="" ></span>
	        </div>
     </li> 
     <li class='h5n'>
          ...
          <input type="text" value="" ondblclick="img_view(this.value);" class="form-control applys h5" id="attachment_test" name="background" size="100" style="width:230px;margin-right:5px;position:relative;" placeholder="背景640*430px" > 
     ...
     <li class='h5n'>
	         ...
	         <label class="labelf"><span class='red'>*</span>分享图标</label>
		          <input type="text" value="" ondblclick="img_view(this.value);" class="form-control" id="share" name="share" size="100" style="width:230px;margin-right:5px;position:relative;" placeholder='300px*300px'>
	        ...
	        <label class="labelf"><span class='red'>*</span>分享标题</label>	
	          <textarea style="width:230px;height:30px;margin-left:10px;" name="sharetitle" id='sharename' placeholder="24个字符以内"  ></textarea>
	        </div><br/>
	     	<div class="layui-form-label layui-form-area" style="margin-top:5px;">
	          ...
	          <textarea style="width:300px;margin-top:10px;height:50px;margin-left: -9px;" name="content" id="content" placeholder="34个字符以内"  ></textarea>
	        </div>
	        </div>
     </li> 
  </ul>
   ...
   <input name="submit"  class="save-bt btn btn-info" id="add" value="新增内容" style="margin-left:30px;">
	   <table class="table table-striped table-advance table-hover" >
	     ...
	     <tr>
	         ...
	         <th class="tablehead">报名按钮</th>
	         <th class="tablehead">去广告（慎重！要花钱！）</th>
	         <th class="tablehead">管理操作</th>
	     </tr>
	     </thead>
	   </table>
   <div class="attaclist"><div id="activity"><ul id="pic_ul"></ul></div></div>
   <center>
   	   <div>
   	   	 <input name="submit" type="submit" class="save-bt btn btn-infos" id="wz-button-submit-b"  onclick=""  value="保存" >
