    ...
    <div class="row">
            <section class="panel">
                <header class="panel-heading">
                    <form action="?m=workitems&f=workitem&v=lst<?php echo $this->su();?>" class="form-inline"  method="post">
                  ...
                  &nbsp;&nbsp;&nbsp; <!--<a href="?m=workitems&f=workitem&v=add<?php /*echo $this->su();*/?>"class="btn btn-default btn-sm" >添加活动</a>-->
                        ...
                        <?foreach ($res as $k => $re) {?>
                         <tr>
                             ...
                             <td>
                                ...
                                <!-- <a href="?m=workitems&f=workitem&v=channelEdit&id=<?php /*echo $re['id']; echo $this->su()*/?>" class="btn btn-info btn-xs" attr-id='<?php /*echo $re['id']*/?>' attr-status='-1' attr-message='渠道推广' >渠道推广</a>-->
                             </td>
                         </tr>
                       <?}?>
                     </tbody>
...
<script>
    var SCOPE = {
      'set_status_url' : '?m=workitems&f=workitem&v=status<?php echo $this->su();?>',
      'set_edit_url' : '?m=workitems&f=workitem&v=edit<?php echo $this->su();?>',
    }
</script>
