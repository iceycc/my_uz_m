                ...
                <form action="?m=Mjin&f=special&v=Deletes<?php echo $this->su();?>" class="form-inline"  id="form6" method="post">
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <th class="textName"style="padding-left:20px;"><h4>序号</h4></th>
                                ...
                                <a href="?m=Mjin&f=special&v=listing&cid=39&pai=tshang<?php echo $this->su();?>"class="shang1" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=special&v=listing&cid=39&pai=txia<?php echo $this->su();?>"class="xia1" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                <th class="textName"style="padding-left:150px;"><h4>链接</h4></th>
                                <th class="textName"style="padding-left:20px;"><h4>干预值</h4>
                                  <a href="?m=Mjin&f=special&v=listing&cid=39&pai=gshang<?php echo $this->su();?>"class="shang1" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=special&v=listing&cid=39&pai=gxia<?php echo $this->su();?>"class="xia1" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
