                      ...
                      <center><table class="table table-striped table-advance table-hover" style='width:1500px;'>
                            ...
                            <th class="textName"style="padding-left:20px;"><h4>序号</h4></th>
                                ...
                                <th class="textName"style="padding-left:30px;"><h4>城市</h4>
                                   ...
                                   <th class="textName"style="padding-right:20px;"><h4><p class="collect">作品数(精品)</p></h4><br/> 
                                  <a href="?m=Mjin&f=designer&v=listing&cid=39&pai=lshang&designers=<?php echo $designers?>&keytypes=<?php echo $keytypes?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                  <a href="?m=Mjin&f=designer&v=listing&cid=39&pai=lxia&designers=<?php echo $designers?>&keytypes=<?php echo $keytypes?><?php echo $this->su();?>"><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                ...
                                <th class="textName"style="padding-left:20px;"><h4><p class="collect">收藏数</p></h4><br/>
                                 <a href="?m=Mjin&f=designer&v=listing&cid=39&pai=sshang&designers=<?php echo $designers?>&keytypes=<?php echo $keytypes?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=designer&v=listing&cid=39&pai=sxia&designers=<?php echo $designers?>&keytypes=<?php echo $keytypes?><?php echo $this->su();?>"><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                             </th>
