                 ...
                 <span class="dropdown examine">
                    ...
                    <form action="?m=Mjin&f=content&v=listing<?php echo $this->su();?>" class="form-inline"  method="post" id='form7'>
                          ...
                          <select name="keytypes" class="form-control" style="float:left; height:35px;">
                            ...
                            <input type="text" name="title" placeholder="搜索标题" class="input" style="height:35px; width:200px; " value="<?php  echo $name;?>">
                        ...
                        <table class="table table-striped table-advance table-hover">
                            ...
                            <th class="textName"style="padding-left:20px;"><h4>序号</h4></th>
                                ...
                                <th class="textName"style="padding-left:45px;"><h4><p class="collect">更新时间</p></h4><br/> 
                                  <a href="?m=Mjin&f=content&v=listing&type=updatetime&pai=shang&title=<?php echo $name;?>&keytypes=<?php echo $keytypes;?>
                                 <?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                  <a href="?m=Mjin&f=content&v=listing&type=updatetime&pai=xia&title=<?php echo $name;?>&keytypes=<?php echo $keytypes;?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                               </th>
                                <th class="textName"style="padding-left:0px;"><h4><p class="collect">浏览数</p> </h4><br/>

                                <a href="?m=Mjin&f=content&v=listing&type=browsenum&pai=shang&title=<?php echo $name;?>&keytypes=<?php echo $keytypes;?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=content&v=listing&type=browsenum&pai=xia&title=<?php echo $name;?>&keytypes=<?php echo $keytypes;?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                <th class="textName"style="padding-left:20px;"><h4><p class="collect">收藏数</p></h4><br/>
                                 <a href="?m=Mjin&f=content&v=listing&type=collectnum&pai=shang&title=<?php echo $name;?>&keytypes=<?php echo $keytypes;?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=content&v=listing&type=collectnum&pai=xia&title=<?php echo $name;?>&keytypes=<?php echo $keytypes;?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                <th class="textName"style="padding-left:20px;"><h4><p class="collect">干预值</p></h4><br/>
                                <a href="?m=Mjin&f=content&v=listing&type=intervene&pai=shang&title=<?php echo $name;?>&keytypes=<?php echo $keytypes;?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=content&v=listing&type=intervene&pai=xia&title=<?php echo $name;?>&keytypes=<?php echo $keytypes;?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                            ...
                            <?php 
                             ...
                             foreach($result AS $key =>$Mjin) { ?>
                              ...
                              ?>
                               ...
                               <?php if(!empty($name)){echo str_replace($name,'<font color="red" >'.$name.'</font>',$Mjin['name']);}else{
                                      echo $Mjin['name'];}?>
                               </a>
                               </td>
                               <td style="padding-left:30px;">
                                   <?  $res = $this->db->get_one('company_team','id="'.$Mjin["designer"].'"' , '*');
                                    echo str_replace($name,'<font color="red" >'.$name.'</font>',$res['title']) ?>
                              </td>
                               <td style="padding-left:30px;"><?php if(!empty($name)){echo str_replace($name,'<font color="red" >'.$name.'</font>',$Mjin['companyname']);}else{
