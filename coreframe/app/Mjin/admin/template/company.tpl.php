                ...
                <form action="?m=Mjin&f=content&v=Deletes<?php echo $this->su();?>" class="form-inline"  id="form6" method="post">
                      <table class="table table-striped table-advance table-hover">
                            ...
                            <th class="textName"style="padding-left:20px;"><h4>序号</h4></th>
                                ...
                                <th class="textName"style="padding-left:20px;margin-bottom:1px;"><h4 style="margin-bottom:1px;">设计师数(精品)</h4>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=dshang&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=dxia&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                <th class="textName"style="padding-left:20px;"><h4 <h4 style="margin-bottom:1px;">案例数(精品)</h4>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=ashang&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=axia&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                <th class="textName"style="padding-left:45px;"><h4><p class="collect">浏览数</p></h4><br/> 
                                  <a href="?m=Mjin&f=company&v=listing&cid=39&pai=lshang&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                  <a href="?m=Mjin&f=company&v=listing&cid=39&pai=lxia&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                <th class="textName"style="padding-left:30px;"><h4><p class="collect">收藏数</p></h4><br/>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=sshang&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=sxia&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                <th class="textName"style="padding-left:20px;"><h4><p class="collect">服务水平</p></h4><br/>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=fshang&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=fxia&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                 <th class="textName"style="padding-left:20px;"><h4><p class="collect">施工质量</p></h4><br/>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=sishang&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=sixia&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                 <th class="textName"style="padding-left:20px;"><h4><p class="collect">服务态度</p></h4><br/>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=tshang&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=txia&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                 <th class="textName"style="padding-left:20px;"><h4><p class="collect">综合评分</p></h4><br/>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=zshang&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=zxia&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a>
                                </th>
                                ...
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=gyshang&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Asc.gif"?>" alt="" id="Asc"></a>
                                <a href="?m=Mjin&f=company&v=listing&cid=39&pai=gyxia&title=<?php echo $keytypes?>&com=<?php echo $coms?><?php echo $this->su();?>" ><img src="<? echo R."images/Desc.gif"?>" alt="" id="Desc"></a> 
                                </th>
                            </tr>
                            </thead>
                            <tbody>
                               ...
                               foreach($company AS $key =>$Com) { ?>
                                ...
                                <td style="padding-left:40px;padding-right:20px;"> &nbsp;<?php $k=$pagess*10;if($k==0){echo $key+1;}else{
                                echo $k+$key+1-10;}?></td>
